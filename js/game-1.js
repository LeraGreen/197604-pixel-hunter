...
const moduleGameOneElement = createEl(gameOneEl);
const form = moduleGameOneElement.querySelector(`.game__content`);
const checkRadioButtons = (radioName) => {
...
form.addEventListener(`change`, () => {
  if (checkRadioButtons(`question1`) && checkRadioButtons(`question2`)) {
