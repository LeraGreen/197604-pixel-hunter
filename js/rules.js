...
const moduleRulesElement = createEl(rulesEl);
const nameUserInput = moduleRulesElement.querySelector(`.rules__input`);
const rulesButton = moduleRulesElement.querySelector(`.rules__button`);
const rulesForm = moduleRulesElement.querySelector(`.rules__form`);
